...
view : Model -> Dict Int String -> List String -> List String -> Html Msg
view model picDict picPosition picStyle =
...
-- helper functions for the gallery component, mostly Dictionary specific operations, heavily dependent on how we define our dictionaries in Main
