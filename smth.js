...
var $author$project$ComponentInterface$subscriptions = function (model) {
	return A2(
...
var $author$project$ComponentInterface$keysToUpdate = _List_fromArray(
	[
		_Utils_Tuple2(
		'pics',
...
var $author$project$Gallery$getModelNum = F2(
	function (pics, model) {
		var _v0 = A2(
			$elm$core$Dict$get,
			function () {
				var _v1 = A2($elm$core$Dict$get, 0, pics);
				if (_v1.$ === 'Just') {
					var value = _v1.a;
					return value;
				} else {
	...
	function (msg, model, keysToUpdate) {
		switch (msg.$) {
			...
			default:
				var time = msg.a;
				var updateValue = F3(
					function (key, len, value) {
						return $elm$core$Maybe$map(
							function (v) {
								return (_Utils_cmp(v, len) > 0) ? 1 : (v + value);
							});
					});
				var updateKey = F2(
					function (_v1, dict) {
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$initialModel, subscriptions: $author$project$Main$componentSubcriptions, update: $author$project$Main$update, view: $author$project$Main$view});
